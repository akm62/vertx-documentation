...
public class MainVerticle extends AbstractVerticle {
  ...
  public static void main(String[] args) {
    System.out.println("Swagger3 implementation");
  ...
  @Override
  public void start(Promise<Void> startPromise) throws Exception {//change
...
//  }
  ...
  private Router configurationRouter() {
    ...
    router.route()
      .failureHandler(ErrorHandler.create(vertx,true));//change
    ...
    /*
    Tagging section. This is where we can group end point operations;
    The tag name is then used in the end point annotation
     */
    ...
    // Generate the SCHEMA section of Swagger, using the definitions in the Model folder
        ...
        for(ClassPath.ClassInfo modelClass : modelClasses){
          ...
          Field[] fields = FieldUtils.getFieldsListWithAnnotation(modelClass.load(), Required.class).toArray(new Field[0]);
    ...
    router.route("/doc/*")
            .handler(StaticHandler.create().setCachingEnabled(false).setWebRoot("webroot/node_modules/swagger-ui-dist"));
